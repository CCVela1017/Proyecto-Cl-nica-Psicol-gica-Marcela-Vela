...
def front_end(frame, frame2):
    def show_image(event):
        ...
        conexion = sqlite3.connect('src/database')
        cursor = conexion.cursor()
        cursor.execute("SELECT Imagen FROM objetos_de_equipo WHERE Serie = ?", (serie_row,))
    ...
    lb_image = customtkinter.CTkLabel(master=frame, text='Imagen: ', font=("Times New Roman", 20))
